...
export default function WhatsappConnect() {
  ...
  return (
    <div className="flex justify-center pt-8">
      <div className="w-full max-w-md bg-[#F5F7FA] rounded-2xl shadow-xl border border-[#0D0D0D] p-6 text-center space-y-4 transition-all">
        {connected ? (
          <>
            <p className="text-[#252625] text-xl font-semibold flex items-center justify-center gap-2">
              ✅ Conectado ao WhatsApp!
            </p>

            {account && (
              <div className="text-sm text-[#252625] bg-[#F5F7FA] rounded-lg p-4">
